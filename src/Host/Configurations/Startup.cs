namespace TD.WebApi.Host.Configurations;
...
internal static class Startup
{
    internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
    {
        ...
        builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/telegrambot.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/telegrambot.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
